...
suite('startServer', () => {
    ...
    suite('component serving', () => {
        ...
        test('serves component files from an npm package', () => __awaiter(this, void 0, void 0, function* () {
            const app = start_server_1.getApp({
        ...
        test('serves component files from a bower package w/ package.json', () => __awaiter(this, void 0, void 0, function* () {
            const app = start_server_1.getApp({
        ...
        test('serves component files from a package w/ n config', () => __awaiter(this, void 0, void 0, function* () {
            const app = start_server_1.getApp({
